...
const LandingPage: React.FC = () => {
  ...
  const setShopifyUrl = useSetupStore((state) => state.setShopifyUrl);

  const handleNext = () => {
    const shopifyUrlInput = document.getElementById('shopify-url') as HTMLInputElement;
    const shopifyUrl = shopifyUrlInput ? shopifyUrlInput.value : '';
    ...
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col items-center py-10">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-3xl mb-12">
        ...
        <div className="flex justify-between items-center">
          ...
          <button onClick={handleNext} className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 flex items-center">
